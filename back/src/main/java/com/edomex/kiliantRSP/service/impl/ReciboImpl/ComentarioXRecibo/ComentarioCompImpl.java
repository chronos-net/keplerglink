...
import com.edomex.kiliantRSP.service.ReciboService.ComentariosxRecibo.ComentarioCompService;
...
public class ComentarioCompImpl implements ComentarioCompService {

    private final JdbcTemplate jdbcTemplate;

    // 🔹 Raw tal cual viene de BD (varchar en importes)
    ...
    @Override
    public List<ComentarioValoresDto> obtenerComp(String neyemp, String periodo, int anio){
        ...
        String sql = """
            ...
            WHERE a.neyemp = ? AND a.anio = ? AND a.quincena = ?
            """;

        List<CompRaw> rawList = jdbcTemplate.query(
                sql,
                mapper,
                neyemp,
                String.valueOf(anio),
